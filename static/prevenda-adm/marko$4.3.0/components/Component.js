$_mod.def("/marko$4.3.0/components/Component", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var domInsert = require('/marko$4.3.0/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var marko = require('/marko$4.3.0/runtime/index'/*'../'*/);
var getComponentsContext = require('/marko$4.3.0/components/ComponentsContext'/*'./ComponentsContext'*/).$__getComponentsContext;
var componentsUtil = require('/marko$4.3.0/components/util-browser'/*'./util'*/);
...
var RenderResult = require('/marko$4.3.0/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.3.0/components/update-manager'/*'./update-manager'*/);
var morphdom = require('/marko$4.3.0/morphdom/index'/*'../morphdom'*/);
var eventDelegation = require('/marko$4.3.0/components/event-delegation'/*'./event-delegation'*/);
