$_mod.def("/marko$4.3.0/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.3.0/components/util-browser'/*'./util'*/);
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.3.0/components/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
