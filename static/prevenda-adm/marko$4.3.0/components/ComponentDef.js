$_mod.def("/marko$4.3.0/components/ComponentDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var repeatedRegExp = /\[\]$/;
var componentUtil = require('/marko$4.3.0/components/util-browser'/*'./util'*/);
